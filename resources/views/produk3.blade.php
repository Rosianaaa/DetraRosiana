    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="gold-text tm-welcome-header-2">Moccachino</h2>
          <p class="gray-text tm-welcome-description">Moka adalah <span class="gold-text"> minuman kopi yang terbuat dari campuran espreso dengan coklat dan susu.</span> Saat ini campuran Moka-Jawa <span class="gold-text"> biasa dicampur dengan varietas lainnya untuk menciptakan </span>cita rasa yang khas dan unik. Banyak perusahaan kopi yang memiliki campurannya tersendiri</p> 
