    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          <h2 class="gold-text tm-welcome-header-2">Tteokbokki</h2>
          <p class="gray-text tm-welcome-description">Tteokbokki adalah<span class="gold-text"> makanan asal Korea yang terbuat dari tepung beras.</span> Tteokbokki sudah ada di Indonsia karena viral.<span class="gold-text"> Tteokbokki adalah hidangan</span> yang  beras yang dimasak dalam bumbu gochujang yang pedas dan manis. Tepung beras yang dipakai berbentuk bulat batang yang memanjang. Makanan ini juga termasuk dalam makanan internasional.</p> 
