    ...
    <section class="tm-welcome-section">
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description">Ini adalah website Resmi daei Coffee House <span class="gold-text"> Trenggalek. </span>Detra Rosiana Sebagai Owner<span class="gold-text"> Coffee House</span>. Sejak tahun 1971, selalu dan akan selalu mengutamakan kualitas. Kami bersemangat untuk hanya mengambil biji kopi Arabika terbaik secara etis dan memanggangnya dengan sangat hati-hati. Semangat kami terhadap kopi hanya dapat disaingi oleh kecintaan kami untuk berbagi.Ahli kopi kami telah menyaring pengetahuan mereka selama bertahun-tahun menjadi tiga pertanyaan sederhana untuk membantu Anda menemukan kopi yang pasti Anda sukai.</p> 
